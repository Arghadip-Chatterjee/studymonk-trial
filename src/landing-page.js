...
function LandingPage() {
    ...
    return (
        <main className="h-full">
            ...
            <section className="w-full h-[750px] bg-white flex-col justify-between p-10">
                
            <div id="default-carousel" className="relative w-full py-28" data-carousel="slide">
                {/* Carousel wrapper */}
                <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                    {/* Item 1 */}
                    <div className="duration-700 ease-in-out bg-white flex justify-between px-28 py-20" data-carousel-item>
                    ...
                    {/* Item 2 */}
                    <div className="duration-700 ease-in-out bg-white flex justify-between" data-carousel-item>
                        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img className="rounded-t-lg" src="/docs/images/blog/image-1.jpg" alt="" />
                            </a>
